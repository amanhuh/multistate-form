      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex flex-col w-full">
          ...
          <input
            ...
            className={`border-2 border-gray-300 bg-gray-100 focus-visible:bg-white focus-visible:border-blue-700 focus-visible:outline-blue-700 rounded-lg px-3 py-1.5 ${
